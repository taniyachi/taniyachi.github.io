		...
		<div id="page-wrapper">
			...
			<!-- Header -->
                ...
                <li><a href="map4.php">خريطة مكاتب الدورالرابع</a></li>
							...
							<li><a href="login.php" class="button">تسجيل الدخول</a></li>
						</ul>
					</nav>
				</header>
			...
			<!-- Banner -->
				<section id="banner">
					...
					<ul class="actions special">
						...
						<!---<li><a href="#" class="button">المزيد عنا </a></li>---->
					</ul>
				</section>
           <body class="is-preload">
		<div id="page-wrapper">
                <section class="box">
                    <h3>خريطة مكاتب الدور الرابع </h3>
                  
                    <span class="image fit"><img src="images/m4.jpg" alt=""></span>
                     <span class="image fit"><img src="images/m44.jpg" alt=""></span>
                  <!---   <div class="box alt">
